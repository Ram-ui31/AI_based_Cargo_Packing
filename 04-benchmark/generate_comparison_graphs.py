...
literature review (FFD, LAFF, BFD) vs. three external RL baselines
(PackMan/DQN, PCT, Online-3D-BPP-DRL) vs. our best result (Cherry). Eclipse
and Halley are intentionally excluded -- this comparison is about
...
white background, bold value labels, recessive gridlines):
  1. Real 400-package instance cost (all 7 methods).
...
# Real-instance chart: 7 methods (classical x3, RL baselines x3, ours).
REAL_LABELS = ['FFD\n(literature)', 'LAFF\n(literature)', 'BFD\n(literature)',
               'PackMan/DQN\n(external RL)', 'PCT\n(external RL)',
               'Online-3D-BPP-DRL\n(external RL)', 'Cherry\n(ours, best)']
REAL_COLORS = ['#c9a86a', '#b98b52', '#a66f3b', '#6f7d91', '#5a9b8e', '#8C8C8C', '#4c8bf5']
real_costs = [
    ...
    37249,   # PCT (Zhao, Yu & Xu, ICLR 2022), trained and evaluated independently by a teammate
...
# Grand-average chart: all 7 methods.
GRAND_LABELS = ['FFD\n(literature)', 'LAFF\n(literature)', 'BFD\n(literature)',
                'PackMan/DQN\n(external RL)', 'PCT\n(external RL)',
                'Online-3D-BPP-DRL\n(external RL)', 'Cherry\n(ours, best)']
GRAND_COLORS = ['#c9a86a', '#b98b52', '#a66f3b', '#6f7d91', '#5a9b8e', '#8C8C8C', '#4c8bf5']
grand_avgs = [
    ...
    12662,     # PCT (Zhao, Yu & Xu, ICLR 2022), 20-instance sweep, run independently by a teammate
