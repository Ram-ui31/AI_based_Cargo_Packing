...
> **Want to run this on your own instance CSV?** See [`../05-run-instructions/`](../05-run-instructions/) for setup and usage — the short version is `python3 run_halley.py --input /path/to/your_instance.csv`.
